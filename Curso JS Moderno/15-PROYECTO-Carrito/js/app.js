...
function cargarEventListeners() {
    // Cuando agregas un curso presionando "Agreagar al Carrito"
...
function leerDatosCurso(curso) {
    ...
    // Revisa si un elemento ya exsite en el carrito
    ...
    if (existe) {
        ...
        const cursos = articulosCarrito.map(curso => {
            if (curso.id === infoCurso.id) {
                ...
                return curso; // Devuelve los objetos que no seon los duplicados
            }
        });
